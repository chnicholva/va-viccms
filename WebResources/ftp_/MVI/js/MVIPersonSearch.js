        ...
        if (data[i].hasOwnProperty("crme_siteid") && !!data[i].crme_siteid) {
            ...
            */
            if (isPhysicalFacility(facilityCode) && facilityCode != "200") {
                ...
                var middleName = data[i].crme_middlename == null ? _middleName : data[i].crme_middlename;
                var suffix = !!data[i].crme_suffix ? data[i].crme_suffix : _suffix;
                //var suffix = data[i].crme_suffix == null ? "" : data[i].crme_suffix;
                var dateOfBirth = data[i].crme_dobstring == null || data[i].crme_dobstring == '' ? _dob : data[i].crme_dobstring;
                var patientMviIdentifier = data[i].crme_patientmviidentifier == null || data[i].crme_patientmviidentifier == '' ? crme_patientmviidentifier : data[i].crme_patientmviidentifier;
                var patientId = data[i].crme_patientid == null || data[i].crme_patientid == '' ? _icn : data[i].crme_patientid;
                var edipi = data[i].crme_edipi == null || data[i].crme_edipi == '' ? _edipi : data[i].crme_edipi;
                var ssn = data[i].crme_ssn == null || data[i].crme_ssn == '' ? _ssn : data[i].crme_ssn;
                var gender = data[i].crme_gender == null || data[i].crme_gender == '' ? _gender : data[i].crme_gender;
